...
public class MainActivity extends Activity {
	...
	private ImageButton ib_image=null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.findViewById(R.id.ib_image).setOnClickListener(new OnClickListener() {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			case TAKE_PICTURE:
				...
				ib_image.setImageBitmap(newBitmap);
			...
			case CHOOSE_PICTURE:
	            ...
	            try {
					...
					if (photo != null) {
						...
						ib_image.setImageBitmap(smallBitmap);
					}
